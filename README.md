...
use PhpGenHTML as V;
```
Créez une variable contenant un objet View, du namespace PhpGenHTML (ici l'alias `V` est utilisé). Cette variable va nous servir pour récuper le code HTML à afficher.
```php
$view = New V\View();
```
